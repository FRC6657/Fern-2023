...
public class RedCubeShootSub extends SequentialCommandGroup {
  ...
  public RedCubeShootSub(Drivetrain _drivetrain, Intake _intake, Pivot _pivot) {
    ...
    addCommands(
      ...
      new RunCommand(()-> mDrivetrain.drive(0.2, 0, false)).withTimeout(0.5),
